...
const K = 1.7;
const BAR = 36 * K;
// 16:9: the draft sits to the right; 9:16: it sits below.
const LAYOUT = {
  h: { REF: { x: 250, y: 300, w: 980, h: 600 }, DRAFT: { x: 760, y: 360, w: 960, h: 620 }, from: { x: 1560, y: 1060 } },
  v: { REF: { x: 60, y: 560, w: 960, h: 640 }, DRAFT: { x: 100, y: 900, w: 900, h: 760 }, from: { x: 1000, y: 1860 } },
};
