...
<main id="main">
<section class="hero wrap"><div class="hero-copy"><p class="eyebrow">${c.eyebrow}</p><h1>${c.hero}</h1><p class="hero-intro">${c.intro}</p><div class="actions">${download(c)}<a class="text-link" href="#experience">${c.try}<span aria-hidden="true">↘</span></a></div></div><div class="hero-art"><div class="hero-stage" role="img" aria-label="${c.heroArtLabel}"><div class="stage-desk"><span class="stage-desk-roll"></span></div><div class="stage-card stage-strip"><div class="stage-bar"><span class="stage-dots"><i></i><i></i><i></i></span><span class="stage-line"></span></div><div class="stage-tube"><i class="stage-cap"></i></div></div><div class="stage-card stage-pinned"><div class="stage-bar"><span class="stage-dots"><i></i><i></i><i></i></span><span class="stage-line"></span></div><div class="stage-lines"><i></i><i></i><i></i></div><div class="stage-blocks"><i></i><i></i></div></div><div class="stage-card stage-panel"><div class="stage-panel-head"><i></i><i></i></div><ul class="stage-panel-list"><li><i></i><b></b></li><li><i></i><b></b></li><li><i></i><b></b></li></ul></div><div class="stage-dock"><i></i><i></i><i></i><i class="is-hovered"></i><i></i></div><span class="stage-pointer" aria-hidden="true"></span></div></div>
</section>
